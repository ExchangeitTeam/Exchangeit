...
class DialogPage extends StatefulWidget {
  ...
  DialogPage({Key? key, required this.profileImg, required this.senderName, required this.senderId})
      : super(key: key);
...
class _DialogPageState extends State<DialogPage> {
  ...
  Future getName() async {
    ...
    await FirebaseFirestore.instance.collection('Users').doc(widget.currUser).get();
  ...
  void initState(){
    super.initState();
    chats.where('users', isEqualTo: {widget.senderId:null, widget.currUser: null})
    .limit(1)
    .get()
    .then(
  ...
  void sendMessage(String msg){
    ...
    chats.doc(widget.chatDocId).collection('messages').add({
      'createdOn': DateFormat('yyyy-MM-dd hh:mm:ss').format(DateTime.now()).toString(), //DateTime.now().formattoString(),
      'msg': msg,
              ...
              ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return Container(
                        ...
                        child: Align(
                          alignment: (isReceiver(messages[index]['friendName']) == true
                              ? Alignment.topLeft
                              : Alignment.topRight),
                          child: Container(
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(20),
                              color: (isReceiver(messages[index]['friendName']) == true
